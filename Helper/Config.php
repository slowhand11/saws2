...
class Config extends \Magento\Framework\App\Helper\AbstractHelper {
  ...
  const XML_PATH_IMPORT_SECURITY_TOKEN  = 'fastsimpleimport/default/import_security_token';
  ...
  */
  public function getImportToken () {
    return $this->scopeConfig->getValue(self::XML_PATH_IMPORT_SECURITY_TOKEN, ScopeInterface::SCOPE_STORE);
  }
